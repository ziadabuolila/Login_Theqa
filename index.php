                    ...
                    <table class='table table-bordered table-striped' id='table'>
                        ...
                        <tbody id='body-data'>
                            <?php
                                ...
                                $result = mysqli_query($conection,'SELECT * FROM employee_specific');
                                $i = 1;
                                            ...
                                            <td>
                                                <div class='dropdown'>
                                                    ...
                                                    <div class='dropdown-menu' style='position: absolute; transform: translate3d(2px, 35px, 0px); top: 0px; left: 0px; will-change: transform;' x-placement='bottom-start'>
                                                        <form action='show/show.php' type='submit' method='post'>
                                                        ...
                                                        <form action='php/postpone.php' type='submit' method='post'>
                                                            <input type='hidden' id='id' name='id' value='$row[user_id]'>
                                                            <button class='btn btn-dark text-white w-100 m-1'>
                                                                تأجيل
                                                            </button>
                                                        </form>
