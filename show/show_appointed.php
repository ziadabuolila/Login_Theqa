...
<html lang='ar'>
    ...
    <body>
        <?php
            ...
            $ID = $_POST['id'];
            $select = mysqli_query($conection, "SELECT * FROM employee_appointed WHERE user_id=$ID");
        ...
        <script>
            ...
            function ExportToPDF() {
                ...
                space_5.innerHTML = `<br><br><br><br><br><br><br><br><br>`;
                space_6.innerHTML = `<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>`;
